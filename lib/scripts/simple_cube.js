...
let post_process_fragment_code = "" +
    ...
    "   float mouse_dist2 = smoothstep(radius*6.+0.01, radius, .04*sin(time)+length(mouse_dir)*3.);" +
    "   vec3 color = texture2D(raw_scene, pos+mouse_dir*.1*mouse_dist2*(1.-1./(0.2+30.*pow(dot(mouse_dir, mouse_dir), 10.)))).rgb;" +
