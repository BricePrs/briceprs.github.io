...
let vertex_code = "uniform vec2 mouse_pos;\n" +
    ...
    "\n" +
    "\n" +
    "    mod_vertexPos.xz *= rotate((mouse_pos.x-.5) * 0.1);\n" +
    "    mod_vertexPos.yz *= rotate((mouse_pos.y-.5) * 0.1);\n" +
    "\n" +
    "\n" +
...
let proj_matrix = get_perspective(3., 3./aspect_ratio, 0.1, 10);
